        ...
        <div class="site-contain row">
            ...
            <div class="col-md-12 left-col">
                ...
                <a class="btn btn-blue" href="{{url('admin/posts')}}"><i class="fa fa-caret-left"></i> Back to posts</a>
                    ...
                    <form id="create-post" action="{{url('admin/posts/')}}/{{$post->id}}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @endif
                                <input type="text" class="form-control input-lg" name="ptitle" value="{{$post->title}}" />
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-md-12">
                                ...
                                @endif
                                <textarea name="pbody" id="pbody" rows="10" cols="80">{{$post->body}}</textarea>
                            </div>
                        </div>
                        
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-blue btn-lg">Save Post</button>
                            </div>
                        </div>
