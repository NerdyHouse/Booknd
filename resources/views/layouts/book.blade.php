...
<head>
    ...
    <title>{{$book->title}} On {{ config('app.name', 'Booknd') }}</title>
    
    <meta property="og:site_name" content="Booknd"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="{{$book->title}} On {{ config('app.name', 'Booknd') }}"/>
    <meta property="og:description" content="See who is reading and reviewing {{$book->title}} on Booknd."/>
    <meta property="og:url" content="{{url('book')}}/{{$book->id}}"/>
    
    @empty($book->image)
    <meta property="og:image" content="{{ asset('images/books/book-placeholder.png') }}"/>
    @else
    <meta property="og:image" content="{{ str_replace('-M','-L',$book->image) }}"/>
    @endempty
                    ...
                    <div class="collapse navbar-collapse" id="app-navbar-collapse">
                        ...
                        <ul id="user-nav" class="nav navbar-nav navbar-right">
                            ...
                            @if (Auth::guest())
                                ...
                                <li class="fb-login-link"><a href="{{url('/fbredirect')}}"><i class="fa fa-facebook"></i> Facebook Login</a></li>
                            @else
